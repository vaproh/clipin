...
<template>
  <NuxtLink :to="`/app/campaigns/${campaign.id}`" class="block group">
    <div class="rounded-lg bg-neutral-950 border border-neutral-800 p-4 space-y-3 cursor-pointer hover:border-neutral-700 hover:-translate-y-0.5 transition-all duration-200">
      <!-- Header: title + badges -->
